        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-12">
          <div className="text-center md:text-left">
            ...
            <p className="text-white/60 text-sm max-w-xs">
              Системно строим отделы продаж и управляем ими на результат с 2019 года.
            </p>
          </div>
          ...
          <div className="flex gap-4">
            <a 
              ...
              className="p-4 glass-dark rounded-2xl hover:scale-110 transition-all border border-white/10 group"
              aria-label="Telegram"
            >
