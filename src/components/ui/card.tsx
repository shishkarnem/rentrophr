...
const CardGlassDark = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div 
      ref={ref} 
      className={cn(
        "glass-dark rounded-3xl text-white transition-all duration-300",
        className
      )} 
      {...props} 
    />
...
export { Card, CardGlass, CardGlassDark, CardHeader, CardFooter, CardTitle, CardDescription, CardContent };
