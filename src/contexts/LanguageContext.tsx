...
export const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'registration.contractRuWorldIp': 'Договор для России и Мира для ИП',
    'registration.contractRuSz': 'Договор для России для самозанятых',
    'registration.contractKzCisIp': 'Договор для Казахстана и СНГ для ИП',
    'registration.contractKzCisSz': 'Договор для Казахстана и СНГ для самозанятых',
    'registration.contractWorldIp': 'Договор для Всего Мира для ИП',
    'registration.download': 'Скачать',
  ...
  en: {
    ...
    'registration.contractRuWorldIp': 'Contract for Russia and World for IP',
    'registration.contractRuSz': 'Contract for Russia for self-employed',
    'registration.contractKzCisIp': 'Contract for Kazakhstan and CIS for IP',
    'registration.contractKzCisSz': 'Contract for Kazakhstan and CIS for self-employed',
    'registration.contractWorldIp': 'Contract for Worldwide for IP',
    'registration.download': 'Download',
  ...
  kz: {
    ...
    'registration.contractRuWorldIp': 'Ресей және әлем үшін ЖК шарты',
    'registration.contractRuSz': 'Ресей үшін өзін-өзі жұмыспен қамтыған шарты',
    'registration.contractKzCisIp': 'Қазақстан және ТМД үшін ЖК шарты',
    'registration.contractKzCisSz': 'Қазақстан және ТМД үшін өзін-өзі жұмыспен қамтыған шарты',
    'registration.contractWorldIp': 'Бүкіл әлем үшін ЖК шарты',
    'registration.download': 'Жүктеу',
