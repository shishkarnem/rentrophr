...
const translations = {
  ru: {
    title: 'Договор ИП РФ',
    subtitle: 'Заполните форму для создания договора',
  },
  en: {
    title: 'IP RF Contract',
    subtitle: 'Fill out the form to create a contract',
  },
  kz: {
    title: 'ЖК РФ шарты',
    subtitle: 'Шарт жасау үшін форманы толтырыңыз',
  },
};
...
const ContractFormIPRF = () => {
  ...
  // Build prefilled URL
  const baseUrl = 'https://docs.google.com/forms/d/e/1FAIpQLSduTGBz8k7ccC9POp7H4LZ-yTqzrH-mCIDOmiyxL4K_lUJobQ/viewform';
...
export default ContractFormIPRF;
