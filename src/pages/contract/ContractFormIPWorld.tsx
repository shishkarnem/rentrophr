...
const ContractFormIPWorld = () => {
  ...
  // Get current date in English format for prefill (e.g., "17 August 2026")
  const now = new Date();
  ...
  // Build prefilled URL
  const buildFormUrl = () => {
    const baseUrl = 'https://docs.google.com/forms/d/e/1FAIpQLSfgyCO3Hs1mYsYKVjFVt0eOJ29GULX3JjglzJBWKWmu1IWf9g/viewform';
...
export default ContractFormIPWorld;
