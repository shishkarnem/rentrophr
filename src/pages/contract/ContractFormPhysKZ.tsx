...
const translations: Record<Language, { title: string; loading: string; gdprNotice: string }> = {
  ru: { 
    title: 'Договор Самозанятый KZ и СНГ', 
    loading: 'Загрузка...',
  ...
  en: { 
    title: 'Self-Employed KZ & CIS Contract', 
    loading: 'Loading...',
  ...
  kz: { 
    title: 'Өзін-өзі жұмыспен қамтыған KZ және ТМД шарты', 
    loading: 'Жүктелуде...',
...
const ContractFormPhysKZ = () => {
  ...
  // Build prefilled URL
  const buildFormUrl = () => {
    const baseUrl = 'https://docs.google.com/forms/d/e/1FAIpQLSfdhCbQViVULHzmDlFMo3Cx0enaqV7SwyqE2OnoZgKrsmlLNA/viewform';
...
export default ContractFormPhysKZ;
