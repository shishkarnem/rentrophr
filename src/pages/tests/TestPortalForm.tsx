...
const formConfigs: Record<Language, { formId: string; minHeight: string }> = {
  ru: {
    formId: "1FAIpQLSfOy1-Xu0r9z5NmX_yCT602rxlhpL2KFnT-jqSfie6F81NvlQ",
    minHeight: "3851px"
  },
  en: {
    formId: "1FAIpQLSesQK4hMoo03lmXHiU8UtX-zO_wP3kaZWXnJdyXXyoe-zI3YA",
    minHeight: "3935px"
  },
  kz: {
    formId: "1FAIpQLScrobqI8cccQSriT16Slm100zhCf0jp5ImwX7F5FzXnln8guw",
    minHeight: "3851px"
  }
};

const translations: Record<Language, { headerTitle: string; back: string; loading: string }> = {
  ru: { headerTitle: "Тест Портал", back: "Назад", loading: "Загрузка..." },
  en: { headerTitle: "Portal Test", back: "Back", loading: "Loading..." },
  kz: { headerTitle: "Портал тесті", back: "Артқа", loading: "Жүктелуде..." }
};

const TestPortalForm = () => {
