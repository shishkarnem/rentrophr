...
const translations: Record<Language, {
  ...
  ru: {
    ...
    chatNote: "и отправляются в личку, если вы указываете правильно свой КОД.",
  ...
  en: {
    ...
    chatNote: "and sent to private messages if you enter your CODE correctly.",
  ...
  kz: {
    ...
    chatNote: "және жеке хабарламаларға жіберіледі, егер сіз КОДТЫ дұрыс енгізсеңіз.",
