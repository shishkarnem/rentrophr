        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl sm:text-5xl font-black text-white mb-8">
              <span className="text-gradient-gold">{t('community.title')}</span>
            </h1>
            ...
            <CardGlassDark className="p-8">
              ...
              <div className="space-y-6 text-white/70 leading-relaxed">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <a href={SOCIAL_LINKS.telegram} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-4 glass-dark rounded-xl hover:bg-white/10 transition-colors group">
                  ...
                  <a href={SOCIAL_LINKS.vk} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-4 glass-dark rounded-xl hover:bg-white/10 transition-colors group">
                  ...
                  <a href={SOCIAL_LINKS.youtube} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-4 glass-dark rounded-xl hover:bg-white/10 transition-colors group">
